...
from multi_decoder_T5 import T5ForConditionalGeneration
...
class DataTrainingArguments:
    ...
    NER_validation_file: Optional[str] = field(default='', metadata={"help": "Whether to Constraint Decoding or not."})
    NER_test_file: Optional[str] = field(default='', metadata={"help": "Whether to Constraint Decoding or not."})
...
def main():
    ...
    if tokenizer.encode("<extra_id_0> <extra_id_1> <extra_id_2>") != [32099, 32098, 1]:
        # For non-t5 tokenizer
        tokenizer.add_special_tokens(
            {"additional_special_tokens": ["<extra_id_0>", "<extra_id_1>", "<extra_id_2>", "<extra_id_3>", "<extra_id_4>", "<extra_id_5>", "<extra_id_6>", "<extra_id_7>"
            , "<extra_id_8>", "<extra_id_31>", "<extra_id_32>", "<extra_id_33>", "<extra_id_34>", "<extra_id_11>", "<extra_id_12>", "<extra_id_13>", "<extra_id_14>", "<extra_id_15>", "<extra_id_16>", 
            "<extra_id_17>", "<extra_id_40>", "<extra_id_50>", "<extra_id_51>", "<extra_id_52>", "<extra_id_53>", "<extra_id_54>", "<extra_id_55>", 
            "<extra_id_61>","<extra_id_62>","<extra_id_63>","<extra_id_64>",]})
    ...
    if training_args.do_eval:
        ...
        # NER_eval_dataset = datasets["NER_validation"]
        ...
        # NER_eval_dataset = NER_eval_dataset.map(
        #     preprocess_function,
        #     batched=True,
        #     num_proc=data_args.preprocessing_num_workers,
        #     remove_columns=column_names,
    ...
    if training_args.do_predict:
        ...
        # NER_test_dataset = datasets["NER_test"]
        ...
        # NER_test_dataset = NER_test_dataset.map(
        #     preprocess_function,
        #     batched=True,
        #     num_proc=data_args.preprocessing_num_workers,
        #     remove_columns=column_names,
    ...
    f1_file = './seq2seq/' + training_args.file_name + '_f1.json'
    f1_dic = {}
    epoch_dic = {'epoch': 1}
    def compute_metrics(eval_preds):
        ...
        # print(decoded_preds, decoded_labels) 到这里为止是扁平序列
        ...
        f1_dic[str(epoch_dic['epoch'])] = result['micro_avg_f1']
        epoch_dic['epoch'] += 1
    ...
    trainer = ConstraintSeq2SeqTrainer(
        ...
        eval_dataset={'DEE': eval_dataset} if training_args.do_eval else None,
        tokenizer=tokenizer,
        data_collator=data_collator,
        multi_task_metrics={'DEE': compute_metrics} if training_args.predict_with_generate else None,
        decoding_format=data_args.decoding_format,
    ...
    if training_args.do_predict:
        ...
        if trainer.is_world_process_zero():
            ...
            test_metrics = get_extract_metrics(pred_lns=test_preds,
                decoding_format=data_args.decoding_format,
                template_file="./data/text2tree/one_ie_ace2005_subtype/test copy.json")
